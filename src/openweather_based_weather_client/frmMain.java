...
public class frmMain extends javax.swing.JFrame {
    ...
    */
    ...
    public void EnimerwsiTrexontwsKairou() throws SQLException, JSONException {
        ...
        insertData = conn.prepareStatement("INSERT INTO tbl_weatherdata (city_id, city, temperature, weather_description, clouds, wind_speed, dt, rain, snow) VALUES (?,?,?,?,?,?,?,?,?)");
        
        // Προετοιμασία μετεωρολογικών δεδομένων
        insertData.setLong(1, kairos.getCityID());
        insertData.setString(2, kairos.getName());
        insertData.setDouble(3, kairos.getTemp());
        insertData.setString(4, kairos.getDesc());
        insertData.setInt(5, kairos.getClouds());
        insertData.setDouble(6, kairos.getWindSpeed());
        insertData.setTimestamp(7, kairos.getDt());
        insertData.setDouble(8, kairos.getRain());
