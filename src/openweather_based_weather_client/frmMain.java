...
public class frmMain extends javax.swing.JFrame {
    ...
    public void Sindesi() throws SQLException {
           try {
                ...
                */
                String dbURL = "jdbc:derby:dbWeather;create=true;user=admin1;password=ergasia3";
                conn = DriverManager.getConnection(dbURL);
                if (conn != null) { // Εάν πραγματοποιηθεί σύνδεση με τη βάση δεδομένων
                    
                    /*
                     * Έλεγχος για το αν υπάρχουν οι απαιτούμενες στήλες στο βάση δεδομένων.
                     * Αν αυτές δεν υπάρχουν, τότε θα δημιουργηθούν αυτόματα.
                    */
                    ...
                    //selectAll = conn.prepareStatement("SELECT * FROM tbl_WeatherData");
                    //ResultSet apotelesma = selectAll.executeQuery();
                    System.out.println("sinde8ike");
                }
